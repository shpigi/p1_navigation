...
Submitted solution to the Udacity DRL course.
...
0. follow the instructions at https://github.com/udacity/deep-reinforcement-learning to install dependencies. Start the drlnd conda environment.
